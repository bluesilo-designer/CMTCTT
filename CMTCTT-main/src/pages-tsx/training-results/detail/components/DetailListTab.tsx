...
export function DetailListTab({ courseware, setCourseware }: DetailListTabProps) {
    ...
    <div className="p-6 space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        {DETAIL.details.map((detail, idx) => {
          ...
          return (
            <div key={detail.id} className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition-shadow">
              {/* Card header */}
