...
export function DetailListStep({ onBack, onConfirm }: { onBack: () => void; onConfirm: () => void }) {
  ...
  if (showEdit) return <EditDetailListPage onBack={() => setShowEdit(false)} onConfirm={handleEditConfirm} />;
            ...
            {DETAIL_GROUPS.map((group: any) => (
              <div key={group.station}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {group.details.map((detail: any, i: number) => (
