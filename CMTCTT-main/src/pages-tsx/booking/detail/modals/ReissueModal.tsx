...
export function ReissueModal({ open, onClose }: { open: boolean; onClose: () => void }) {
      ...
      <div className="space-y-5">
        <div>
          ...
          <div className="relative">
            <Button
              type="outline"
              onClick={() => { setAssignOpen(!assignOpen); setCwOpen(false); }}
              className={cn("w-full flex items-center justify-between px-4 py-3 border-2 rounded-lg text-sm",
        ...
        <div>
          ...
          <div className="relative">
            <Button
              type="outline"
              onClick={() => { setCwOpen(!cwOpen); setAssignOpen(false); }}
