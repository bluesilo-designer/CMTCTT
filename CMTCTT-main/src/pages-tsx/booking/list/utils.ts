...
export function bookingDateKeys(dateStr: string): string[] {
...
export function parseBookingTime(raw: string): { date: string; timeRange: string; label: string } {
...
export function extractTime(bookingTime: string): string {
