...
export function OperationalAvailability2() {
  ...
  const columns: ColumnDef<OAMonth, any>[] = [
    {
      id: "no",
      header: () => "No",
      cell: (info: any) => (
    ...
    },
    {
      ...
      cell: (info: any) => (
        <span className="text-sm text-gray-700 font-mono">{info.getValue()}</span>
      ),
    },
    {
      accessorKey: "totalDT",
    ...
    },
    {
      ...
      cell: (info: any) => <AOBadge value={info.getValue()} />,
    },
    {
      accessorKey: "action",
      header: () => "",
      ...
      <div className="p-6">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <InputCustom
                ...
                className="pl-8 pr-3 py-2 text-sm border border-gray-200 rounded-lg w-52 focus:ring-1 focus:ring-brand-primary focus:border-brand-primary bg-white"
              />
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <TableCustom
            ...
            classTheadTh="bg-red-50 text-brand-primary font-semibold text-xs"
            getNestedComponent={(row) => <BookingRows record={row.original} />}
