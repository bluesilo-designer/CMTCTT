...
import type { User } from "@/data/userManagement";
  ...
  const columns = useMemo<ColumnDef<User, any>[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        header: () => "No",
        cell: ({ row }) => (
          <div onClick={() => onNavigate?.("/user-management/user-detail")} className="cursor-pointer text-gray-500 font-medium">
      ...
      },
      {
        ...
        cell: (info) => (
          <div
            onClick={() => onNavigate?.("/user-management/user-detail")}
      ...
      },
      {
        ...
        cell: () => (
          <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => onNavigate?.("/user-management/user-detail")}
              className="p-1 rounded text-gray-400 hover:text-brand-primary hover:bg-gray-100 transition-colors"
            >
              <Eye size={16} />
            </button>
            <UserRowMenu
