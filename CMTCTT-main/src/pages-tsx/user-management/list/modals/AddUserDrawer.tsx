              ...
              <Form className="flex flex-col flex-1 overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <button
                        type="button"
                        className="mt-1.5 text-xs text-brand-primary hover:underline font-medium"
                      >
                        Upload photo
                      </button>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <SelectField
                          label="Rank"
                          value={values.rank}
                          onChange={(v) => setFieldValue("rank", v)}
                          options={RANKS}
                ...
                <div className="px-6 py-4 border-t border-gray-200 flex gap-3 flex-shrink-0">
                  ...
                  <Button
                    ...
                    disabled={!canSubmit}
                    className={cn(
                      "flex-1 px-4 py-2.5 text-sm font-medium text-white transition-colors",
                      canSubmit
