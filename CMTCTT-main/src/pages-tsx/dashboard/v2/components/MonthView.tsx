...
export function MonthView() {
  ...
  const busiest = Object.entries(aprilBookings).reduce<[string, number]>(
    (a, b) => (b[1] > a[1] ? (b as [string, number]) : a),
    ["0", 0]
  );
