            ...
            <table className="w-full">
              <thead>
                <tr className="bg-red-50 border-b border-gray-100">
                  ...
                  <th className="text-left px-4 py-3 text-xs font-semibold text-brand-primary">Description</th>
                </tr>
              </thead>
              <tbody>
                {paginated.map((log) => (
                  <tr key={log.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3.5 text-sm">
                      <div className="text-gray-800 font-medium">{log.name}</div>
                      <div className="text-gray-400 text-xs">{log.role}</div>
                    </td>
                    ...
                    <td className="px-4 py-3.5 text-sm text-gray-700 whitespace-pre-line">{log.date}</td>
                    <td className="px-4 py-3.5 text-sm text-gray-700">{log.description}</td>
                  </tr>
                ))}
              </tbody>
            </table>
