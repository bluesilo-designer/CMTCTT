...
interface AddVersionModalProps {
  onClose: () => void;
  onAdd: (v: Omit<VersionEntry, "id">) => void;
}
...
export function AddVersionModal({ onClose, onAdd }: AddVersionModalProps) {
  const handleSubmit = (values: { version: string; notes: string }) => {
    const now = new Date();
    const date =
