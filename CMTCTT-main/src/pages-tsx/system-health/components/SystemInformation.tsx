...
export function SystemInformation({ initialSection, onBack }: SystemInformationProps) {
        ...
        <div className="flex gap-5">
          ...
          <div className="flex-1 bg-white rounded-xl border border-gray-200 p-5">
            <DetailPanel
              ...
              onSelectItem={setSelectedItemLabel}
            />
          </div>
        </div>
      </div>
