      ...
      <div className="flex items-center gap-2 flex-shrink-0 ml-4">
        <div className="relative">
          ...
          <InputCustom
            ...
            className="pl-8 pr-3 py-1.5 text-sm border border-gray-200 rounded-md w-48 focus:ring-1 focus:ring-brand-primary focus:border-brand-primary"
          />
        </div>
