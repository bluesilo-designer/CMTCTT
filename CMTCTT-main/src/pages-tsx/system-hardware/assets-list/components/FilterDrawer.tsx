...
export function FilterDrawer({ isOpen, onClose }: FilterDrawerProps) {
  ...
  const someTypesSelected =
    selectedTypes.length > 0 && selectedTypes.length < ASSET_TYPES.length;
    ...
    <>
      ...
      >
                ...
                <Checkbox
                  ...
                  onChange={() =>
                    setSelectedCategories(
                      allCategoriesSelected ? [] : [...ASSET_CATEGORIES],
                    )
                  }
                  size={16}
                />
        ...
        <div className="border-t border-gray-200 p-4 md:p-6 flex flex-col sm:flex-row gap-3">
          ...
          <Button
            onClick={onClose}
            className="flex-1 py-2.5 bg-brand-primary text-white rounded-lg text-sm font-semibold hover:bg-brand-primary-hover"
          >
            Apply Filters
          </Button>
        </div>
