...
export function SuccessModal({ onClose, onViewAssignment }: SuccessModalProps) {
  return (
    <Modal open={true} onClose={onClose} width={384} isUseX={false}>
      <div className="flex flex-col items-center text-center">
        ...
        <Button
          ...
          className="w-full px-5 py-2.5 bg-brand-primary text-white text-sm font-semibold rounded-xl hover:bg-brand-primary-hover"
        >
          View Assignment
        </Button>
      </div>
