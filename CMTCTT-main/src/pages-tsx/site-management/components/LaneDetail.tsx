...
import { type LaneDetailTab } from "../constants";
...
export function LaneDetail({
  ...
  const [activeTab, setActiveTab] = useState<LaneDetailTab>("details");
  const [blackoutDates, setBlackoutDates] = useState<string[]>(lane.blackoutDates);
      ...
      <div className="p-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="flex border-b border-gray-200 px-6">
            {([
              { key: "details" as LaneDetailTab, label: "Lane Details" },
              { key: "blackout" as LaneDetailTab, label: "Blackout Dates" },
            ]).map(({ key, label }) => (
