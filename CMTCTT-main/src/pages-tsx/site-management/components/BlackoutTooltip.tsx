...
export function BlackoutTooltip({ dates }: { dates: string[] }) {
    ...
    <div className="flex flex-col gap-0.5">
      ...
      {extra.length > 0 && (
        <div ref={ref} className="relative inline-block">
          ...
          {show && (
            <div className="absolute left-0 top-full mt-1.5 z-30 bg-white border border-gray-200 rounded-xl shadow-xl p-3 min-w-[240px]">
