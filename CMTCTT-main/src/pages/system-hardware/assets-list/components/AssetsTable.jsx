...
export function AssetsTable({ data, currentPage, onPageChange, onEdit, onNavigate, }) {
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            accessorKey: "name",
            header: () => "Asset",
            cell: (info) => (<div className="text-sm text-gray-800 font-medium">
        ...
        },
        {
            ...
            cell: (info) => (<div className="text-sm text-gray-700">
        ...
        },
        {
            id: "status",
            header: () => "Status",
            cell: (info) => (<AssetStatusBadge status={info.row.original.status}/>),
        },
        {
            id: "issuedDate",
        ...
        },
        {
            ...
            cell: (info) => {
              ...
              <button onClick={() => onNavigate?.(`/system-hardware/asset-detail/${asset.id}`)} className="text-gray-400 hover:text-gray-600 p-2">
                <Eye size={16}/>
              </button>
              <Dropdown Icon={<MoreVertical size={16} className="text-gray-400"/>} positionType="bottom-right" className="w-40">
                <button onClick={() => onEdit(asset)} className="w-full flex items-center gap-2 px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 border-b border-gray-100">
                  <Edit2 size={16}/>
                  Edit
                </button>
