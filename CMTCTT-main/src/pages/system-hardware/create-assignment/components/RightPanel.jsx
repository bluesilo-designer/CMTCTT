export function RightPanel({ bookingData }) {
    const bd = bookingData;
    if (!bd)
        return null;
    const weapons = bd.weaponList || [];
    const totalUnits = weapons.reduce((s, w) => s + w.quantity, 0);
    return (<div className="w-1/2 flex-shrink-0">
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm sticky top-6 overflow-hidden">
        ...
        <div className="px-5 py-4 border-b border-gray-100 bg-gray-50/60">
          ...
          {weapons.length > 0 && (<p className="text-xs text-gray-400 mt-0.5">
        ...
        <div className="p-4 max-h-[calc(100vh-14rem)] overflow-y-auto">
          {weapons.length === 0 ? (<div className="py-8 flex flex-col items-center text-center text-gray-400">
              ...
              {weapons.map((w, i) => (<div key={i} className="rounded-xl border border-gray-100 bg-gray-50/50 overflow-hidden">
                  {/* Weapon name bar */}
