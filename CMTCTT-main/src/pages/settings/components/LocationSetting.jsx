...
export function LocationSetting() {
    ...
    const columns = [
        columnHelper.display({
            id: "select",
            header: () => (<Checkbox checked={allSel} indeterminate={someSel && !allSel} onChange={toggleAll} size={16}/>),
    ...
    return (<div>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        {selected.size > 0 && (<button onClick={handleDeleteSelected} className="flex items-center gap-1.5 text-sm font-medium text-red-500 hover:text-red-600">
