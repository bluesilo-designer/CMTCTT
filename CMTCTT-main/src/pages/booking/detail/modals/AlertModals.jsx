...
export function AttendanceConfirmationModal({ open, attendeesCount, onConfirm, onCancel, }) {
    return (<Modal open={open} onClose={onCancel} width="450px">
...
export function FinalConfirmationModal({ open, traineesCount, onConfirm, onCancel, }) {
    return (<Modal open={open} onClose={onCancel} width="450px">
      <div className="flex items-center gap-4 mb-6 -mt-2">
...
export function Case2AttendanceSummaryModal({ open, trainees, onCancel, onConfirm, }) {
    ...
    return (<Modal open={open} onClose={onCancel} width="550px">
...
export function Case2UnregisteredAlert({ open, onCancel, onUpdate, }) {
    return (<Modal open={open} onClose={onCancel} width="400px">
...
export function Case2SuccessAlert({ open, onClose }) {
    return (<Modal open={open} onClose={onClose} width="400px">
      <div className="text-center pb-2">
