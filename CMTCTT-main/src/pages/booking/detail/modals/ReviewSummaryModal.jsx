...
export function ReviewSummaryModal({ onCancel, onConfirm }) {
    ...
    return (<div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4 md:p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        ].map(([label, value]) => (<div key={label} className="flex items-start justify-between px-4 py-2.5 border-b border-gray-50 last:border-b-0">
            ...
            ["Courseware(s)", "ATP (M)"],
        ].map(([label, value]) => (<div key={label} className="flex items-center justify-between px-4 py-2.5 border-b border-gray-50">
...
export function SessionReadyModal({ onStart }) {
    return (<div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8 text-center relative">
        ...
        <Button onClick={onStart} className="w-full py-3 text-sm font-bold bg-brand-primary text-white hover:bg-brand-primary-hover justify-center">
          Start session
        </Button>
      </div>
    </div>);
