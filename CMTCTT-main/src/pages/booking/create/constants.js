export const PROGRAMS = [
    { id: "SWT", title: "Specialised Weapon Trainer (SWT)", desc: "Focused on mastering advanced weapon handling and operations.", bg: "from-gray-900 via-gray-700 to-gray-800" },
    { id: "CMT", title: "Company Tactical Mission Trainer (CMT)", desc: "Enhances team tactical skills through mission simulations.", bg: "from-gray-800 via-gray-600 to-gray-700" },
    { id: "CTT", title: "Command Team Trainer (CTT)", desc: "Strengthens leadership in strategic planning and operations.", bg: "from-gray-900 via-gray-700 to-gray-600" },
];
export const STEPS = ["Booking Details", "Lane Configuration", "Nominal Roll", "Schedule"];
export const TRAINING_MODES_BY_TYPE = {
...
export const COURSEWARE_BY_MODE = {
    Marksmanship: [
...
export const TIME_OPTIONS = Array.from({ length: 24 }, (_, h) => [`${String(h).padStart(2, "0")}:00`, `${String(h).padStart(2, "0")}:30`]).flat();
